...
export const Footer = () => {
  return (
    <footer className="relative pt-20 pb-10 overflow-hidden border-t border-white/15 bg-black text-white">
      {/* Background effects */}
              ...
              {[
                ...
                return (
                  <a 
                    key={index}
                    href={social.href}
                    className="group w-11 h-11 rounded-xl bg-white/10 backdrop-blur-sm border border-white/20 hover:border-white/35 flex items-center justify-center transition-all duration-300 hover:scale-110"
                  >
            ...
            <ul className="space-y-3">
              {["AI Features", "Pricing", "Case Studies", "Documentation", "API", "Support"].map((link, index) => (
                <li key={index}>
                  <a 
                    href="#" 
                    className="text-white/70 hover:text-accent-cyan transition-colors inline-flex items-center gap-2 group"
                  >
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <a href="mailto:info@nthplace.com" className="text-white/70 hover:text-accent-cyan transition-colors">
                  info@nthplace.com
                </a>
              </li>
              <li className="flex items-start gap-3">
                ...
                <a href="tel:+911234567890" className="text-white/70 hover:text-accent-cyan transition-colors">
                  +91 123 456 7890
                </a>
              </li>
              <li className="flex items-start gap-3">
