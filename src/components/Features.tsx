  ...
  <div className="grid md:grid-cols-2 gap-4">
    {features.map((feature, index) => {
      ...
      return (
        <div 
          key={index} 
          className="group flex items-start gap-4 p-5 rounded-2xl bg-white/10 backdrop-blur-sm border border-white/15 hover:border-white/30 transition-all duration-300 hover:scale-[1.02]"
        >
      ...
      <div className="container mx-auto px-6 lg:px-8 relative z-10">
        <div className="max-w-4xl mx-auto text-center mb-20">
          ...
          <h2 className="font-heading text-5xl lg:text-6xl font-bold mb-6">
            ...
            <br />
            <span className="text-white">For Every Role</span>
          </h2>
        ...
        <div className="max-w-6xl mx-auto">
          <Tabs defaultValue="universities" className="w-full">
            <TabsList className="grid w-full grid-cols-3 max-w-3xl mx-auto mb-16 h-auto p-1.5 bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl text-white/70">
              <TabsTrigger 
                value="universities" 
                className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-accent-cyan data-[state=active]:to-accent-blue data-[state=active]:text-primary-foreground py-4 rounded-xl font-bold text-base transition-all duration-300 data-[state=inactive]:text-white/70"
              >
                Universities
              </TabsTrigger>
              <TabsTrigger 
                value="recruiters"
                className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-accent-purple data-[state=active]:to-accent-cyan data-[state=active]:text-primary-foreground py-4 rounded-xl font-bold text-base transition-all duration-300 data-[state=inactive]:text-white/70"
              >
                Recruiters
              </TabsTrigger>
              <TabsTrigger 
                value="students"
                className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-accent-blue data-[state=active]:to-accent-purple data-[state=active]:text-primary-foreground py-4 rounded-xl font-bold text-base transition-all duration-300 data-[state=inactive]:text-white/70"
              >
                Students
              </TabsTrigger>
            </TabsList>
            ...
            <TabsContent value="universities" className="mt-0">
              <div className="p-10 rounded-3xl bg-white/10 backdrop-blur-xl border border-white/20">
