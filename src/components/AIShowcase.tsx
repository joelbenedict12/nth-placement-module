    ...
    <section className="py-32 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 lg:px-8 relative z-10">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-7xl mx-auto mb-20">
          {aiCapabilities.map((capability, index) => {
            ...
            return (
              <div
                key={index}
                className="group relative p-8 rounded-3xl bg-card/40 backdrop-blur-xl border border-card-border hover:border-card-border-hover transition-all duration-500 hover:scale-105 overflow-hidden"
              ...
              >
                ...
                <h3 className="font-heading text-xl font-bold mb-3 text-foreground group-hover:text-accent-cyan transition-colors">
                  {capability.title}
                </h3>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="relative p-10 rounded-3xl bg-gradient-to-r from-card/60 via-card/40 to-card/60 backdrop-blur-xl border border-card-border-hover overflow-hidden">
