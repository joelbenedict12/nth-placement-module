    ...
    <section className="py-32 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 lg:px-8 relative z-10">
        <div className="max-w-5xl mx-auto">
          {/* Main CTA Card */}
          <div className="relative p-12 lg:p-16 rounded-3xl bg-card/60 backdrop-blur-xl border border-card-border-hover overflow-hidden">
            {/* Gradient overlay */}
            ...
            <div className="relative z-10 text-center">
              {/* Badge */}
              <div className="inline-flex items-center gap-2 px-4 py-2 mb-8 rounded-full bg-card/60 backdrop-blur-sm border border-card-border-hover">
              ...
              <div className="flex flex-col sm:flex-row gap-5 justify-center items-center">
                ...
                <Button 
                  size="lg" 
                  variant="outline"
                  className="border-2 border-accent-cyan/50 text-foreground hover:bg-card/50 hover:border-accent-cyan backdrop-blur-sm font-bold px-12 py-7 text-lg rounded-2xl transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-accent-glow/30"
                >
