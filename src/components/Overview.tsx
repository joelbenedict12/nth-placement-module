          ...
          {roles.map((role, index) => {
            ...
            return (
              ...
              >
                ...
                <div className="relative h-full p-8 rounded-3xl bg-white/10 backdrop-blur-xl border border-white/15 hover:border-white/30 transition-all duration-500 overflow-hidden">
                  ...
                  <h3 className="font-heading text-2xl font-bold mb-4 text-white group-hover:text-accent-cyan transition-colors">
                    {role.title}
                  </h3>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {role.features.map((feature, idx) => (
                      <span 
                        key={idx}
                        className="px-3 py-1.5 text-xs font-semibold rounded-lg bg-white/10 border border-white/20 text-accent-cyan"
                      >
                        {feature}
                      </span>
                    ))}
